...
| `2026-08-04-defs-us-preamble` | `claude/defs-us-preamble` | **ACTIVE structural replanning.** Generic occurrence slicing was rejected after 11,283 all-53 deltas/9,058 unexplained. M-R107 requires separate AR/ID and TX structural proposals, future-law controls with unseen IDs/terms/wording, and zero unexplained union deltas. Vaquill-AI PR #4 remains retracted; HI/FED are source-held. | 3rd pending merge slot |
