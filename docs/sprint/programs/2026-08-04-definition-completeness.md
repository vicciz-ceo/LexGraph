...
| `2026-08-04-defs-us-preamble` | `claude/defs-us-preamble` | **ACTIVE occurrence-local planning.** Vaquill-AI PR #4 was retracted; fork QA is evidence only and HI 16/FED 2 remain source-held. M-R106 authorizes a four-file LexGraph metadata seam for AR 1/ID 2/TX 12; production remains frozen pending Planner REDs and all-53 classification. | 3rd pending merge slot |
