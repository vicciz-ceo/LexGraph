...
| `2026-08-04-defs-us-preamble` | `claude/defs-us-preamble` | **ACTIVE source-split planning.** Upstream `open-us-law` draft PR #4 is QA-approved at `4a62757` but not published: HI 16/FED 2 remain held for a corrected pinned Hugging Face snapshot. LexGraph Planner owns only the AR 1/ID 2/TX 12 occurrence-local B1 repair; production remains frozen. | 3rd pending merge slot |
